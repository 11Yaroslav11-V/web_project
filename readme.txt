...
!!! ЕСЛИ НЕ ЗАПУСКАЕТСЯ ПРОГРАММА НУЖНО ИЗМЕНИТЬ ORM.RELATION
 НА ORM.RELATIONSHIP И ПОСТАВИТЬ HTML5 В ФОРМАХ РЕГИСТРАЦИИ И АВТОРИЗЦИИ!!!
